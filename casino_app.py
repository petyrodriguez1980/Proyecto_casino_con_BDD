...
def mostrar_reloj_js(estilo="mediano"):
    size_css = {
        "grande": ("font-size: 40px;", 100),
        "mediano": ("font-size: 28px;", 80),
        "chico": ("font-size: 20px;", 60)
    }
    estilo_fuente, alto = size_css[estilo]

    reloj_html = f"""
    <div style="text-align: center">
        <h3 style='{estilo_fuente}'>🕒 <span id="reloj">--:--:--</span></h3>
    </div>
    <script>
    ...
    """
    components.html(reloj_html, height=alto)
